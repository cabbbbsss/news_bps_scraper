...
- **Real-time Scraping**: Fallback scraping langsung dari web ketika database offline
...
### 🔧 Advanced Features
- **Offline Mode**: Tetap bisa scraping ketika database server down
...
3. **Jika Database Offline**: Gunakan fitur "Scraping Manual" di bagian bawah untuk scraping langsung
4. **Filter BPS**: Gunakan dropdown untuk filter berdasarkan kategori BPS
...
- **Offline Capability**: Tetap bisa scraping dari web meski database down
...
├── classifier_ollama_v4.py          # OLLAMA classification (legacy)
